...
const BrandDetails = () => {
  ...
  return (
    <div className="brand-details">
      ...
      <img src={brand.brand_logo || 'default-logo.png'} alt={brand.brand_name} />
      ...
      <div className="coupons">
        {brand.coupons.map(coupon => (
          <div className="coupon-card" key={coupon.coupon_code}>
            ...
            <button onClick={() => copyCouponCode(coupon.coupon_code)}>Copy Code</button>
            <a href={brand.shop_link} target="_blank" rel="noopener noreferrer">Use Now</a>
          </div>
        ))}
      </div>
    </div>
