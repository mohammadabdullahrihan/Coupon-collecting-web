...
const ErrorPage = () => {
  return (
    <div className="error-page  lg:ml-[370px]">
     ...
     <Link to={'/'}>
     <button className='bg-black text-white px-5 py-5 rounded-3xl text-xl font-semibold ml-[110px] lg:ml-[250px]'>Go Back</button>
     </Link>
    </div>
  )
};
