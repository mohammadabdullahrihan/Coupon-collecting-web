    ...
    <div className="container-2 lg:flex">
        <div className="ml-[30px]">
            ...
            <form className="form relative" onSubmit={handleLogin}>
                ...
                <span onClick={handleForgotPassword} className="forgot-password mt-[10px] ml-[10px]">
                    <a href="#" className="text-[15px] text-[#0099ff] no-underline">Forgot Password?</a>
                </span>
                <input
                    value="Login"
                    type="submit"
            ...
            <div className="social-account-container">
                ...
                <div className="flex-col-1 space-y-3">
                    ...
                    <button
                        ...
                        className="button x flex items-center border border-gray-200 py-3 px-[52px] rounded-[19px] text-[13px] font-medium"
                    >
                        <svg
                            className="bg-black w-6 rounded-full mr-2"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="#ffffff"
                        >
